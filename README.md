...
2. Looking for archetypes: Applying game data mining to hearthstone decks (2022)
   ...
   - (Leitura não concluída) O artigo se propõe a usar a análise de arquétipos para identificar bons decks já existentes e com isso ver como as classes de carta de relacionam a fim de montar o deck ideal.
